...
import './App.css'
import { InboxIcon, HomeIcon, ProfileIcon, SearchIcon, AddIcon } from "./icons/TabBar"
  ...
  return (
    <div className="app">
      {loading && <div role="status">
        <svg aria-hidden="true" class="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-400 fill-blue-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
